...
export function ComingSoonPanel({ deadlineIso }: { deadlineIso: string | null }) {
  return (
    <div className="tg-corner-tl tg-corner-tr relative flex flex-col items-center justify-center gap-3 border border-[var(--border)] bg-[var(--card)] p-16 text-center">
